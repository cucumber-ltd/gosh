...
const MemoryUniqueIndex = loggable(require('./index/memory/unique_index'))
const MemoryOptionalUniqueIndex = loggable(
  require('./index/memory/optional_unique_index')
)
const MemoryOneToManyIndex = loggable(
  require('./index/memory/one_to_many_index')
)
