...
const MemoryManyToManyIndex = require('./index/memory/many_to_many_index')
...
module.exports = class DocumentStore {
  ...
  withUniqueIndex(makeKey) {
    ...
    const index = new MemoryManyToManyIndex({
      makeId,
      makeKeys: doc => [makeKey(doc)],
    })
