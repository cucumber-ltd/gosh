...
describe('Gosh', () => {
  ...
  context('emitting events', () => {
    ...
    it('calls an update event', () => {
      store.put(dave)
      store.put({ name: 'dave', shoes: 'brown' })
      assert.deepEqual(called, { insert: dave, update: { name: 'dave', shoes: 'brown' } })
    })
    ...
    it('calls a delete event', () => {
      ...
      store.put({ name: 'dave', shoes: 'brown' })
      store.delete(dave)
      assert.deepEqual(called, { insert: dave, update: { name: 'dave', shoes: 'brown' }, delete: { name: 'dave', shoes: 'brown' } })
    })
  })
})
